...
const data = [
  ...
  const userSixTask = data.filter(task => userId == 6);
  console.log(userSixTask);
  //filter for user 6 incomplete tasks
  const userSixIncompleteTask = userSixTask.filter(
    task => task.completed != true
  );
  console.log(userSixIncompleteTask);
